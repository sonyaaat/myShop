...
})({"2Ia9v":[function(require,module,exports) {
"use strict";
...
const about = async ()=>{
    const res = await (0, _getCurrentUserDefault.default)();
    if (res === "no") {
        ...
        if (res.role === "user") isUser.classList.remove("none");
        else {
            console.log(add);
...
},{"./getCurrentUser":"6rjEI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6rjEI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2Ia9v","hS7Ir"], "hS7Ir", "parcelRequired7c6")

//# sourceMappingURL=basket.90c04c5e.js.map
