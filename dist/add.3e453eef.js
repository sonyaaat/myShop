...
})({"dWj40":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "519ca6083e453eef";
...
},{}],"lGgAj":[function(require,module,exports) {
...
const onSubmit = (evt)=>{
    evt.preventDefault();
    const { elements: { name , quantity , price , description  } ,  } = evt.target;
    ...
    if (!name || !quantity || !price || !description || !downloaded) {
        (0, _sweetalertDefault.default)("Oops!", "Fill all the fields");
        return;
    }
    console.log("formdata", ...formData);
    console.log(name.value, quantity.value, price.value, description.value);
    (0, _axiosDefault.default).post("http://localhost:3000/api/admin/items", formData).then((res)=>{
        console.log(res);
        (0, _sweetalertDefault.default)("Success!", "Item was added!", "success");
    });
    setTimeout(()=>{
...
},{}]},["dWj40","lGgAj"], "lGgAj", "parcelRequired7c6")

//# sourceMappingURL=add.3e453eef.js.map
