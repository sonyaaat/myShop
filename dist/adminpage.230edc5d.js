...
})({"7nuJu":[function(require,module,exports) {
"use strict";
...
const fetch = async ()=>{
    ...
    (0, _axiosDefault.default).get("http://localhost:3000/api/users").then(function(response) {
        // handle success
    ...
    (0, _axiosDefault.default).get("http://localhost:3000/api/order").then((res)=>{
...
},{"axios":"jo6P5","./getToken":"i9VyJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7nuJu","cHucQ"], "cHucQ", "parcelRequired7c6")

//# sourceMappingURL=adminpage.230edc5d.js.map
