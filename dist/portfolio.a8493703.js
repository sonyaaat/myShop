...
})({"iNy0I":[function(require,module,exports) {
"use strict";
...
(0, _axiosDefault.default).get("http://localhost:3000/api/admin/items").then((res1)=>{
    func(res1.data.data);
}).then(()=>{
...
},{"axios":"jo6P5","./getCurrentUser":"6rjEI","./getToken":"i9VyJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iNy0I","lamKG"], "lamKG", "parcelRequired7c6")
