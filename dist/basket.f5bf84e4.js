...
})({"lfyRB":[function(require,module,exports) {
"use strict";
...
const addMarkup = (items)=>{
    ...
    const markup = items.map(({ name , price , image , itemId  })=>` <section class="product">
          ...
          <div class="product__controls">
              <button type="button" class="basket__remove">
                  <svg width="30px" height="21px" class="icon-bin" >
                      ...
                      <use class="icon-menu" ref="tester" data-deleteId="${itemId}" href="${0, _spriteSvgDefault.default}#icon-bin"></use>
                    </svg>
              </button>
    ...
    Array.from(itemsFronBasket).forEach((link)=>{
        link.addEventListener("click", function(event) {
            ...
            if (event.target.dataset.deleteid) {
                (0, _axiosDefault.default).post(`http://localhost:3000/api/user/items/removeFromFavorite/${event.target.dataset.deleteid}`).then((res)=>{
                    console.log(res);
                    location.reload();
                });
                return;
...
(0, _axiosDefault.default).get("http://localhost:3000/api/user/items/getFav").then((res)=>{
    //   console.log(res.data.items);
    addMarkup(res.data.items);
    console.log("D");
}).then(()=>{}).catch((er)=>console.log(er));

},{"./getCurrentUser":"6rjEI","./getToken":"i9VyJ","axios":"jo6P5","../images/sprite.svg":"icaq8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"icaq8":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("7b9PQ") + "sprite.f14d31f7.svg" + "?" + Date.now();
...
},{}]},["lfyRB","igkur"], "igkur", "parcelRequired7c6")

//# sourceMappingURL=basket.f5bf84e4.js.map
