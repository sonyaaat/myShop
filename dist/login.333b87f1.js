...
})({"hysTa":[function(require,module,exports) {
"use strict";
...
async function handleSubmit(event) {
    ...
    if (login.value === "" || password.value === "") return (0, _sweetalertDefault.default)("Oops!", "Please fill in all the fields!");
    console.log(`Login: ${login.value}, Password: ${password.value}`);
    //event.currentTarget.reset();
    (0, _axiosDefault.default).post("http://localhost:3000/api/auth/login", {
        email: login.value,
...
},{"axios":"jo6P5","./getToken":"i9VyJ","sweetalert":"38a65","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"38a65":[function(require,module,exports) {
!function(t, e) {
    module.exports = e();
}(this, function() {
    return function(t1) {
...
},{}]},["hysTa","47T64"], "47T64", "parcelRequired7c6")
