...
})({"egwzW":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "33ad1912312c4f76";
...
const addToBasket = ()=>{
    ...
    addBtn.addEventListener("click", ()=>{
        const itemId1 = localStorage.getItem("item");
        (0, _axiosDefault.default).post(`http://localhost:3000/api/user/items/addToFavorite/${itemId1}`).then((res)=>{
            //const {name,description,price,quantity,image}=res.data
            console.log(res);
            (0, _sweetalertDefault.default)("Added!", "Your item was added!", "success");
        // render(name,description,price,quantity,image)
        }).catch((er)=>{
            console.log(er.response.data.message);
            if (er.response.data.message === "This item was already added to favorites") {
                console.log("added");
                (0, _sweetalertDefault.default)("Oops!", "Your item is already added!", "error");
            }
            if (er.response.data.message === "Not Authorized") (0, _sweetalertDefault.default)("Oops!", "Your are Not Authorized!", "error");
        });
    });
};

},{"axios":"jo6P5","./getCurrentUser":"6rjEI","./getToken":"i9VyJ","sweetalert":"38a65","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"38a65":[function(require,module,exports) {
!function(t, e) {
    module.exports = e();
}(this, function() {
    return function(t1) {
...
},{}]},["egwzW","8aqVM"], "8aqVM", "parcelRequired7c6")

//# sourceMappingURL=item.312c4f76.js.map
