...
})({"hnpEH":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "2923f28ab6249d78";
...
},{}],"dZ8GT":[function(require,module,exports) {
...
const editMarkup = (firstName, lastName, username, address, country, city, postalCode, email, avatar)=>{
    if (!firstName) {
        console.log(avatar);
...
const imgChange = (event)=>{
    ...
    (0, _axiosDefault.default).post("http://localhost:3000/api/users/avatar", formData).then(()=>{
...
const handleSubmit = (event)=>{
    ...
    console.log("Change");
    const { elements: { firstname , lastname , postalCode , country , city , address , username ,  } ,  } = event.currentTarget;
    console.log(firstname.value, lastname.value, postalCode.value, country.value, city.value);
    (0, _axiosDefault.default).post("http://localhost:3000/api/users/edit", {
        ...
        (0, _sweetalertDefault.default)("Success!", "Your info was changed!", "success");
        setTimeout(()=>{
...
(0, _axiosDefault.default).get("http://localhost:3000/api/users/userInfo").then((res)=>{
    ...
    const { firstName , lastName , username , address , country , city , postalCode , email , avatar ,  } = res.data.result;
    editMarkup(firstName, lastName, username, address, country, city, postalCode, email, avatar);
}).catch((er)=>console.log(er));
form.addEventListener("submit", handleSubmit);
imageUpload.addEventListener("change", imgChange);

},{"sweetalert":"38a65","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"38a65":[function(require,module,exports) {
!function(t, e) {
    module.exports = e();
}(this, function() {
    return function(t1) {
...
},{}]},["hnpEH","dZ8GT"], "dZ8GT", "parcelRequired7c6")

//# sourceMappingURL=userinfo.b6249d78.js.map
