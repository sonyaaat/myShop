          ...
          <div class="container">
            ...
            <ul class="list features__list">
              <li class="features__item">
                ...
                <p class="features__text">We are very attentive to customers</p>
              </li>
              <li class="features__item">
                <div class="features__photo">
                  <svg class="features__svg">
                ...
                <p class="features__text">Our clothes is very good.</p>
              </li>
              <li class="features__item">
                <div class="features__photo">
                  <svg class="features__svg">
                ...
                <p class="features__text">We have all what you want</p>
              </li>
              <li class="features__item">
                <div class="features__photo">
                  <svg class="features__svg">
          ...
          <div class="container">
            ...
            <ul class="list occupation__list">
              <li class="occupation__item">
                <img src="./images/casual.webp" width="370" />
                <p class="occupation__text">Casual clothes</p>
              </li>
              <li class="occupation__item">
                <img src="./images/sport.webp" width="370" />
                <p class="occupation__text">Sport clothes</p>
              </li>
              <li class="occupation__item">
                <img src="./images/festive.jpeg" width="370" />
