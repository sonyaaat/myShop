...
dispatch(getItem({id}))
  ...
  const onSubmit=(evt)=>{
dispatch(makeOrder({itemId:id, quantity: 1}))
  ...
  <p required type="text" id="input-username" class="form-control form-control-alternative" placeholder="Username" name="username">{username}</p>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group js-email">
                              <label class="form-control-label" for="input-email ">Email address</label>
                              <p  type="email" id="input-email" name="email" class="form-control form-control-alternative">{email}</p>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-6">
                            <div class="form-group focused js-firstname">
                              ...
                              <p class="form-control form-control-alternative">{firstName}</p>
                            </div>
                          </div>
                          <div class="col-lg-6">
                            <div class="form-group focused js-lastname">
                              <label class="form-control-label" for="input-last-name">Last name</label>
                              <p class="form-control form-control-alternative">{lastName}</p>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div class="col-lg-4">
        <div class="form-group">
          ...
          <p class="form-control form-control-alternative">{postalCode}</p>
                     ...
                     <Link to={"/basket"}> <button class="buy__btn buy__btn--submit" type="submit" onClick={onSubmit} >SUBMIT</button></Link>
                     <Link to={"/basket"}> <button class="buy__btn buy__btn--cancel" type="submit">CANCEL</button></Link>
                     </div>
                    </form>:<Link to={"/userInfo"}> <p className="buy__complete">At first complete your personal info</p></Link>}
